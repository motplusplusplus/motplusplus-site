...
export default function Home() {
  return (
    <>
      {/* heading above map */}
      <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "48px 24px 40px" }}>
        <h1 style={{
      ...
      <div style={{
        width: "100%", height: "60vh", minHeight: "380px",
      ...
      <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "72px 24px" }}>
        <div style={{ maxWidth: "860px", marginBottom: "80px" }}>
          <p style={{ fontSize: "16px", fontWeight: 400, lineHeight: 1.7, color: "#444444", marginBottom: "24px" }}>
          ...
          <p style={{ fontSize: "16px", fontWeight: 400, lineHeight: 1.7, color: "#444444", marginBottom: "48px" }}>
          ...
          <p style={{ fontSize: "13px", color: "#999999", letterSpacing: "0.04em" }}>
            ...
            <a href="mailto:motplusplusplus@gmail.com" style={{ color: "#111111" }}>
          ...
          <div style={{
            ...
            {[
              ...
              <Link key={item.href} href={item.href} style={{ textDecoration: "none", color: "inherit" }}>
                <div style={{ position: "relative", width: "100%", aspectRatio: "4/3", overflow: "hidden", backgroundColor: "#111" }}>
                  <img src={item.img} alt={item.label} style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", opacity: 0.7 }} />
                  <div style={{
                    ...
                    <p style={{ fontSize: "16px", fontWeight: 300, color: "#ffffff" }}>{item.label}</p>
                  </div>
                </div>
              </Link>
            ))}
